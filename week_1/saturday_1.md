...
**Resume bullet:**  Deployed a simple HRIS system, Midpoint IGA, LDAP directory on a Linux VM in the cloud; tested connectivity between the 3 systems and verified all services are running.
